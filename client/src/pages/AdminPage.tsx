...
import type { AdminUser, SystemMetrics, LogEntry, ResourceMetrics, MetricSnapshot, AlertRule, AlertHistoryItem, QuotaTier, UserQuotaInfo } from '../services/admin'
    ...
    <div>
      ...
      >
        {quotaInfoLoading ? (
          ...
          <div>
            {currentQuotaInfo && (
              <Card size="small" style={{ marginBottom: 16, background: '#fafaf8' }}>
