...
type ConversationMember struct {
	...
	ConversationID uint64     `json:"conversation_id,string" gorm:"not null;uniqueIndex:idx_conv_user"`
	UserID         uint64     `json:"user_id,string" gorm:"not null;uniqueIndex:idx_conv_user"`
...
type Message struct {
	ID             uint64    `json:"id,string" gorm:"primaryKey"`
	ConversationID uint64    `json:"conversation_id,string" gorm:"not null;index:idx_messages_conv_seq"`
	SenderID       uint64    `json:"sender_id,string" gorm:"not null"`
